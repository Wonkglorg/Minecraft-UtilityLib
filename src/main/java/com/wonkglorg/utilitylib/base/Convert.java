...
public final class Convert {
    ...
    public static String toTime(long timeInMs, DateType... formats) {
        // Sort DateType values from largest to smallest
        ...
        // Handle case where no time units were added (e.g., timeInMs was zero)
        if (sb.isEmpty()) {
            sb.append("0").append(DateType.MILLISECONDS.getPreset());
        }
